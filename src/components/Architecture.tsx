...
const layers = [
  { number: 'Layer 01', name: 'Detect' },
  { number: 'Layer 02', name: 'Analyze' },
  { number: 'Layer 03', name: 'Execute' },
];
      ...
      <div className="w-full max-w-3xl mx-auto px-6 sm:px-8 py-32">
        ...
        >
          ...
          <p className="text-white/45 text-[15px] sm:text-[17px] leading-relaxed max-w-xl mx-auto">
            Detection watches the chain in real time. Analysis evaluates bonding-curve health. Execution snipes with one
            click.
          </p>
        </motion.div>

        {/* Layer cards — centered with proper spacing */}
        <motion.div
