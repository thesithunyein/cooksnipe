        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-white font-light leading-[0.95] tracking-[-0.03em] text-[clamp(40px,10vw,100px)]">
              <ScrambleIn text="SNIP" delay={200} triggered={entranceComplete} />
              <br />
              <ScrambleIn text="MOCKS" delay={500} triggered={entranceComplete} />
            </h1>
            ...
            >
              Real-time MomoSwap launch detection on Cookie Chain. New tokens appear — you snipe them before anyone else.
            </motion.p>
          </div>
          ...
          <div className="text-left md:text-right">
            <h1 className="text-white font-light leading-[0.95] tracking-[-0.03em] text-[clamp(40px,10vw,100px)]">
              <ScrambleIn text="LAUNCH" delay={700} triggered={entranceComplete} />
              <br />
              <ScrambleIn text="DETECT" delay={1000} triggered={entranceComplete} />
            </h1>
          </div>
        </div>
      </motion.div>
