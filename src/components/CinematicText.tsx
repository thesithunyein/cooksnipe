...
export function CinematicText() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-screen h-[100dvh] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 flex items-center justify-center h-full px-6 sm:px-12">
        <div className="max-w-5xl" style={{ perspective: '400px' }}>
          ...
          >
            A real-time sniper built for the fastest SVM chain. CookSnipe detects new MomoSwap launches the instant
            they appear. Every signal becomes a trade. Every millisecond matters.
          </motion.p>
        </div>
      </div>
    </section>
